  ...
  document.body.innerHTML = `
    <div class="app">
      <header class="header">
        <div class="header-content">
          <div class="header-left">
            <img src="/icons/icon32.svg" alt="Veo 3 Logo" class="header-logo" />
            <h1 class="header-title">Veo 3 Prompt Assistant</h1>
          </div>
          <div class="tier-status" id="tier-display" style="
            font-size: 11px;
            background: #6c757d;
            color: white;
            padding: 4px 8px;
          ...
          <div class="header-actions">
            ...
            <button id="sequences-btn" class="icon-button" title="Sequences">🎬</button>
      ...
      <main class="app-content">
        <div id="onboarding-banner" style="display: none;" class="onboarding-banner">
          <h3>🚀 Get Started!</h3>
...
Generate ONLY the new prompt text, optimized for Veo 3.`;
  ...
  function updateTierDisplay() {
    ...
    const status = tierService.getTierStatus();
    const tierDisplay = document.getElementById('tier-display');
    
    if (tierDisplay) {
      tierDisplay.textContent = status.displayName;
      tierDisplay.style.background = getTierColor(status.tier);
      tierDisplay.title = `${status.displayName} - Click to manage your plan`;
    }
  }
  ...
  document.getElementById('tier-display').addEventListener('click', showSettings);
