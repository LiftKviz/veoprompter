// Simplified prompts data for import
window.existingPrompts = [
  {
    category: "ads",
...
console.log('Prompts data loaded:', window.existingPrompts.length, 'prompts available');

// Make it available globally
window.parsedPrompts = window.existingPrompts;